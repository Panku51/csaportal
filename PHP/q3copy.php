...
<div class="wrapper">
			<div class="inner">
				<form action="q4.php" method="post">
					<h3 style="color:#111; padding-bottom:10px;">QUESTION-3</h3>
         ...
         <input type="text" name="ans3" id="ans3" textarea rows="4" cols="60" style="color:#111" d="floatingTextarea" placeholder="Enter 1">
